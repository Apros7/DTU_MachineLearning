...
class Tester():
    ...
    def __init__(self, problem_type : str, path_to_data : str, function_to_test, final_test : bool = False, k : int = 10):
    ...
    def _test_all_folds(self): self.results = [self.func_to_test(self.data_x[fold[0]], self.data_x[fold[1]], self.data_y[fold[0]], self.data_y[fold[1]]) for fold in tqdm(self.fold_combs, desc="Training and testing...")]
